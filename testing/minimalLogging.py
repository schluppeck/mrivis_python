...
from compatibility import getTimeStr  # noqa
...
if __name__ == '__main__':
    ...
    logger, logfileName = setupLogging(name=__name__, level=logging.DEBUG)
    ...
    for i in range(nTrials):
        ...
        print(f"(logging)   Trial {i+1}/{nTrials} at time {t1:.3f} sec")
